...
function FavNote() {
    ...
    return (
        <div>
            ...
            >
                <Grid container marginLeft={0} marginRight={5} justifyContent='center' flex-wrap='wrap'>
                    {state.items && state.items.map((obj) => {
                        ...
                        return (
                            <Grid padding={2} marginLeft={5} marginRight={5} key={obj._id.concat("favnote")}>
                                    ...
                                    <CardContent>
                                        ...
                                        <Box>
                                            <Box className="box-content" sx={{ fontSize: 18, fontWeight: 700 }} marginTop={3} marginBottom={3}>
                                                <NewlineText text={obj.content}  id={obj._id.concat("favnote_newline")}/>
                                            </Box>
                                        </Box>
            ...
            </InfiniteScroll> : ( lenNotes ? <Box style={{ marginTop: 20 }}><h4>Loading...</h4></Box>:<Box style={{ marginTop: 20 }}><h4>You don't have any favorite notes.</h4></Box>)}
        </div>
    )
}
